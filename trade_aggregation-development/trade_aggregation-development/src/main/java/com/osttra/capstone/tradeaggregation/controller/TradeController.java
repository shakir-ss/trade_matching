...
public class TradeController {
	...
	@PostMapping("/trade")
	public CustomResponse<Trade> addNewTrade(@Valid @RequestBody TradeBody body, BindingResult br) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully Retrived List"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you where trying to reach is forbidden") })
	@GetMapping("/trades")
	public CustomResponse<Trade> getAllTrades() {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully Retrived List"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you where trying to reach is forbidden") })
	@GetMapping("/trade/{id}")
	public CustomResponse<Trade> getTradeById(@PathVariable int id) {
	...
	public CustomResponse<CancelTrade> getCancelledTrades(@PathVariable int id) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully Retrived List"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you where trying to reach is forbidden") })
	@PutMapping("/trade/{id}")
	public CustomResponse<Trade> updateTradeById(@PathVariable int id, @Valid @RequestBody TradeUpdateBody body,
			BindingResult br) {
	...
	public CustomResponse<Trade> findTradesByPartyName(@PathVariable String partyName) {
	...
	public CustomResponse<Trade> findTradesByInstitutionName(@PathVariable String institutionName) {
	...
	public CustomResponse<Trade> findByTrnandPartyName(@PathVariable String trn, @PathVariable String partyName) {
	...
	public CustomResponse<Trade> findByStatusandPartyName(@PathVariable String partyName, @PathVariable String status) {
	...
	public CustomResponse<Trade> deleteTradeById(@PathVariable int id) {
