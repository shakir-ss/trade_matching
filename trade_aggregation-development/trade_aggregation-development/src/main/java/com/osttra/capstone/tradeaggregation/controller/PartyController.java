...
public class PartyController {
	...
	@GetMapping("/parties")
	public CustomResponse<Party> getAllParties() {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully Retrived List"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you where trying to reach is forbidden") })
	@GetMapping("/party/{id}")
	public CustomResponse<Party> getPartyById(@PathVariable int id) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully Retrived List"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you where trying to reach is forbidden") })
	@PostMapping("/party")
	public CustomResponse<Party> addParty(@RequestBody PartyBody party) {
	...
	public CustomResponse<Party> getPartybyName(@PathVariable String name) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully Retrived List"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you where trying to reach is forbidden") })
	@PutMapping("/party/{id}")
	public CustomResponse<Party> updatePartyById(@PathVariable int id, @RequestBody PartyBody party) {
	...
	public CustomResponse<Party> deletePartybyId(@PathVariable int id) {
