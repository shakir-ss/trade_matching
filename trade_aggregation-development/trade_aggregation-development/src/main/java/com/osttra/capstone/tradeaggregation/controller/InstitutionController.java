...
public class InstitutionController {
	...
	public CustomResponse<Institution> getAllInstitutions() {
	...
	public CustomResponse<Institution> getInstitutionById(@PathVariable int id) {
	...
	public CustomResponse<Party> getAllParties(@PathVariable int id) {
	...
	public CustomResponse<Institution> addParty(@PathVariable int id, @PathVariable int partyId) {
	...
	public CustomResponse<Institution> addNewInstitution(@Valid @RequestBody InstitutionBody body, BindingResult br) {
	...
	public CustomResponse<Institution> getInstitutionByName(@PathVariable String name) {
	...
	public CustomResponse<Institution> updateInstitution(@PathVariable int id, @RequestBody InstitutionBody body) {
	...
	public CustomResponse<Institution> deleteInstitution(@PathVariable int id) {
	...
	public CustomResponse<Institution> removeParty(@PathVariable int id, @PathVariable int partyId) {
